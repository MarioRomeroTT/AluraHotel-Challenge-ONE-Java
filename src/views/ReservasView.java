...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblCheckIn.setBounds(68, 126, 260, 24);
		lblCheckIn.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		panel.add(lblCheckIn);
		
		JLabel lblCheckOut = new JLabel("FECHA DE CHECK OUT");
		lblCheckOut.setForeground(SystemColor.textInactiveText);
		lblCheckOut.setBounds(68, 208, 260, 27);
		...
		lblValor.setBounds(72, 303, 225, 24);
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				calularValor(txtFechaEntrada, txtFechaSalida); //Activa el evento, después del usuario seleccionar las fechas se debe calcular el valor de la reserva
			}
		});
		...
		txtValor.setBounds(68, 328, 278, 33);
		...
		btnsiguiente.setCursor(Cursor.getPredefinedCursor(Cursor.TEXT_CURSOR));
		
		lblSiguient = new JLabel("SIGUIENTE");
		lblSiguient.setHorizontalAlignment(SwingConstants.CENTER);
		lblSiguient.setForeground(Color.WHITE);
		lblSiguient.setFont(new Font("Roboto", Font.PLAIN, 18));
		lblSiguient.setBounds(0, 0, 122, 35);
